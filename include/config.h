...
// Global debug output switch (1 = enabled, 0 = disabled)
...
static inline NullDebugSerial& getNullDebugSerial() {
	static NullDebugSerial instance;
	return instance;
}

#define DEBUG_SERIAL getNullDebugSerial()
...
#define YAW_GAIN_CALM 1.0
#define YAW_GAIN_LOW_CURRENT 0.9
#define YAW_GAIN_STRONG_CURRENT 0.8

#define MAX_THRUST_CALM 260
#define MAX_THRUST_LOW_CURRENT 320
#define MAX_THRUST_STRONG_CURRENT 380
...
#define YAW_RATE_GAIN_CALM 1.3f          // Lower gain for calm waters
...
#define MANUAL_MAX_YAW_RANGE 380        // Max manual yaw authority
#define MANUAL_MIN_YAW_BITE 35          // Minimum yaw command once steering exits deadband for immediate response
#define MANUAL_STEER_EXPO 0.85f         // <1.0 gives more direct steering around center
#define MANUAL_YAW_SLEW_PER_SEC 650.0f  // Yaw command ramp rate for smoother direction changes
#define MANUAL_STEER_TRIM_US 10         // Steering trim in microseconds (+ right / - left) to compensate RC center bias
...
#define AUTO_HOLD_NEAR_YAW_LIMIT 25.0f       // Max yaw command near hold radius
#define AUTO_HOLD_HEADING_DEADBAND_DEG 10.0f // Larger heading deadband to reduce twitching
#define AUTO_MAX_YAW_COMMAND 95.0f            // Global autonomous yaw cap to avoid spin
#define AUTO_YAW_SLEW_PER_SEC 180.0f          // Autonomous yaw ramp rate
#define AUTO_HEADING_BRAKE_START_DEG 20.0f    // Begin reducing thrust when heading error is large
#define AUTO_HEADING_BRAKE_FULL_DEG 85.0f     // Full thrust reduction reached at this heading error
#define AUTO_MIN_THRUST_SCALE 0.35f           // Minimum thrust scale when facing far from target
